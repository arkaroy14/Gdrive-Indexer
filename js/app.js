...
<br>
<footer class="footer text-muted"> <div class="container"> <p class="float-right"> <a href="#">Back to top</a> </p> ${UI.credit ? '<p>Brought to you with <svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-heart-fill" fill="red" xmlns="http://www.w3.org/2000/svg"> <path fill-rule="evenodd" d="M8 1.314C12.438-3.248 23.534 4.735 8 15-7.534 4.736 3.562-3.248 8 1.314z" /> </svg> by <a href="https://github.com/arkaroy14" target="_blank">Arka Roy Chowdhury</a> and theme from <a href="https://bootswatch.com/" target="_blank">Bootswatch</a>.</p>' : ''} <p>© ${UI.copyright_year} - <a href=" ${UI.company_link}" target="_blank"> ${UI.company_name}</a>, All Rights Reserved.</p> </div> </footer>
  `;
    $('body').html(html);
}
...
<div class="input-group mb-4">
  ...
  <input type="text" class="form-control" id="dlurl" value="${href}">
	...
	<p class="card-text text-center"><a href="${href}" class="btn btn-primary">Download</a> <button onclick="copyFunction()" onmouseout="outFunc()" class="btn btn-success"> <span class="tooltiptext" id="myTooltip">Copy</span> </button></p><br></div>
<script src="https://cdn.jsdelivr.net/gh/arkaroy14/Gdrive-Indexer@master/js/ace/1.4.7/ace.js"></script>
<script src="https://cdn.jsdelivr.net/gh/arkaroy14/Gdrive-Indexer@master/js/ace/1.4.7/ext-language_tools.js"></script>`;
    $('#content').html(content);
